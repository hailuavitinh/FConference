...
N.API.init(config.nuve.superserviceID, config.nuve.superserviceKey, 'http://192.168.1.24:3000/' ); // ////'http://192.168.1.24:3000/'
...
module.exports.GetRoomById = function(req,res){
...
module.exports.CreateRoomById = function(req,res){
    var roomID = req.params.id;
...
module.exports.SetLockRoom = function(req,res){
    var roomID = req.body.id;
